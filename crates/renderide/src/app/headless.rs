...
struct HeadlessSchedule {
    render_interval: Duration,
    next_full_frame_at: Instant,
}

impl HeadlessSchedule {
    fn new(interval_ms: u64, now: Instant) -> Self {
        Self {
    ...
    fn tick_kind(&self, now: Instant) -> HeadlessTickKind {
    ...
    fn complete_full_frame(&mut self, now: Instant) {
