...
{
    var outColor_0 : vec4<f32> = (textureSample((_FontAtlas_0), (unity_usc_resonite_macro_sampler_0), (_S1.uv_0))) * _S1.color_0;
    if((outColor_0.w - 0.00100000004749745f) < 0.0f)
    {
        discard;
    }
    var _S2 : pixelOutput_0 = pixelOutput_0( outColor_0 );
    return _S2;
}
