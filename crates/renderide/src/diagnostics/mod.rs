...
//! **Renderide debug** ([`crate::config::DebugSettings::debug_hud_enabled`]: Stats / Shader routes / Draw state), **Scene transforms** ([`crate::config::DebugSettings::debug_hud_transforms`]),
