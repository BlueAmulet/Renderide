//! Depth clear and compare conventions for the main reverse-Z forward pass and matching raster
//! pipelines (near fragments win with greater depth values in NDC).
