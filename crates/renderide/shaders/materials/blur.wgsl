...
fn refract_offset(uv0: vec2<f32>, world_n: vec3<f32>, world_t: vec4<f32>, clip_recip_w: f32) -> vec2<f32> {
...
fn fs_main(
    ...
    let center_uv = screen_uv - refract_offset(uv0, world_n, world_t, frag_pos.w) * fade;
