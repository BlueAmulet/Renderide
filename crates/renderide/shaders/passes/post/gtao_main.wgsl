...
//!
//! Reads the view-space depth mip chain generated by `gtao_prefilter_*`, reconstructs
//! edge-weighted normals from mip 0, evaluates XeGTAO's slice/step horizon search, and writes
//! the packed AO working term plus denoise edges.
